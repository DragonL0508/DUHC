...
function duhc:player/lobby/ui/player/notification
function duhc:api/ui/create_button {id:"check_settings", slot:12, title:"§f當前遊戲設定", desc:["","§7DUHC有許多特殊玩法","§7點選可查看目前遊戲的設定"], icon:"book", click:"function duhc:player/lobby/ui/player/click/check_settings", type:"normal"}
