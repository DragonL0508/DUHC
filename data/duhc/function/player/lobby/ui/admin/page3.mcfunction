...
data modify storage duhc:main data.temp.range set value {min:0, max:180, n:5}
function duhc:api/ui/create_button {id:"nether_time", slot:3, title:"§e地域關閉(分鐘):", desc:["§7在指定時間前才能進入地域。"], icon:"obsidian", click:"function duhc:player/lobby/ui/admin/click/value", type:"value"}

data modify storage duhc:main data.temp.range set value {min:0, max:180, n:5}
function duhc:api/ui/create_button {id:"daylight_time", slot:4, title:"§e永晝時間(分鐘):", desc:["§7在指定時間後會永久白天。"], icon:"clock", click:"function duhc:player/lobby/ui/admin/click/value", type:"value"}

data modify storage duhc:main data.temp.range set value {min:0, max:180, n:5}
function duhc:api/ui/create_button {id:"peaceful_time", slot:5, title:"§e不再生怪(分鐘):", desc:["§7在指定時間後怪物將不再生成。",], icon:"spawner", click:"function duhc:player/lobby/ui/admin/click/value", type:"value"}

data modify storage duhc:main data.temp.range set value {min:0, max:180, n:5}
function duhc:api/ui/create_button {id:"final_regen_time", slot:6, title:"§e最終回血(分鐘):", desc:["§7在指定時間後，","§7將玩家的血量回滿，提高容錯。"], icon:"nether_wart", click:"function duhc:player/lobby/ui/admin/click/value", type:"value"}

data modify storage duhc:main data.temp.range set value {min:0, max:180, n:5}
function duhc:api/ui/create_button {id:"player_glow_time", slot:7, title:"§e玩家發光(分鐘):", desc:["§7在指定時間後玩家獲得發光效果。"], icon:"glow_ink_sac", click:"function duhc:player/lobby/ui/admin/click/value", type:"value"}
...
function duhc:api/ui/create_button {id:"apple_drop_chance", slot:16, title:"§e蘋果掉落率:", desc:["§7調整蘋果的掉落機率","§7掉落率為 §6數值 x 0.1"], icon:"apple", click:"function duhc:player/lobby/ui/admin/click/value", type:"value"}
