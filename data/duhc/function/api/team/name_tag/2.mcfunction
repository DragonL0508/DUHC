...
function duhc:api/team/name_tag/3 with storage duhc:main data.temp
data remove storage duhc:main data.temp.team[0]
execute if data storage duhc:main data.temp.team[0] run function duhc:api/team/name_tag/2