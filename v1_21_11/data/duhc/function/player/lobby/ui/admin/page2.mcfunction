...
function duhc:api/ui/create_button {id:"team_nametag", slot:4, title:"§e顯示同隊名條:", desc:["§7在名條顯示前，是否顯示隊友的名條","§7(遊戲正式開始後隱藏)"], icon:"name_tag", click:"function duhc:player/lobby/ui/admin/click/toggle", type:"toggle"}

function duhc:api/ui/create_button {id:"health_display", slot:5, title:"§e血量顯示:", desc:["§7是否顯示玩家血量。"], icon:"glass_bottle", click:"function duhc:player/lobby/ui/admin/click/toggle", type:"toggle"}

function duhc:api/ui/create_button {id:"enchanted_gap", slot:6, title:"§e禁用附魔金蘋果:", desc:["§6附魔金蘋果§7會被轉換為§6八個金磚§7與§6蘋果§7。"], icon:"golden_apple", click:"function duhc:player/lobby/ui/admin/click/toggle", type:"toggle"}

function duhc:api/ui/create_button {id:"brewing", slot:7, title:"§e禁用釀造:", desc:["§6地獄疙瘩§7、§6發酵蜘蛛眼§7會被系統回收。"], icon:"brewing_stand", click:"function duhc:player/lobby/ui/admin/click/toggle", type:"toggle"}

function duhc:api/ui/create_button {id:"suspicious_soup", slot:10, title:"§e禁用可疑的燉湯:", desc:["§6可疑的燉湯§7會被系統回收。"], icon:"mushroom_stew", click:"function duhc:player/lobby/ui/admin/click/toggle", type:"toggle"}

function duhc:api/ui/create_button {id:"invisibility", slot:11, title:"§e隱形保護:", desc:["§7玩家在開場五分鐘會獲得隱形效果。"], icon:"glass", click:"function duhc:player/lobby/ui/admin/click/toggle", type:"toggle"}

data modify storage duhc:main data.temp.range set value {min:1, max:1000, n:1}
function duhc:api/ui/create_button {id:"apple_drop_chance", slot:12, title:"§e蘋果掉落率:", desc:["§7調整蘋果的掉落機率","§7掉落率為 §6數值 x 0.1%"], icon:"apple", click:"function duhc:player/lobby/ui/admin/click/value", type:"value"}