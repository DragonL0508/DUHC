...
function duhc:player/lobby/ui/admin/difficulty

function duhc:api/ui/create_button {id:"items", slot:20, title:"§e如何設定起始物資?", desc:["§7大廳中心有一個初始物資箱，","§7使用§6創造模式§7將物資放入即可。"], icon:"chest", click:"", type:"normal"}
