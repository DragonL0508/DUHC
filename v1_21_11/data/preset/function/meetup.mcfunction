#--------------------------------------------------
#DUHC
#data\preset\function\meetup.mcfunction
#
...
# 顯示訊息
function duhc:chat/system/format {target:"@s", msg:"已載入預設: UHC Meetup"}
...
scoreboard players set pvp_time settings 0
scoreboard players set nametag_time settings 0
