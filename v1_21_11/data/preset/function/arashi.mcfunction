#--------------------------------------------------
#DUHC
#data\preset\function\arashi.mcfunction
#
...
# 顯示訊息
function duhc:chat/system/format {target:"@s", msg:"已載入預設: Arashi"}

# 所有設定
scoreboard players set more_crafting settings 1
scoreboard players set cut_clean settings 0
scoreboard players set death_chest settings 1
scoreboard players set time_bomb settings 1
scoreboard players set double_ores settings 0
...
scoreboard players set lucky_leaves settings 0
scoreboard players set more_exp settings 0
...
scoreboard players set meetup settings 0
...
scoreboard players set invisibility settings 0

scoreboard players set pvp_time settings 10
scoreboard players set nametag_time settings 10
scoreboard players set nether_time settings 60
scoreboard players set peaceful_time settings 40
scoreboard players set final_regen_time settings 10
scoreboard players set player_glow_time settings 60
...
scoreboard players set deathmatch_time settings 65
