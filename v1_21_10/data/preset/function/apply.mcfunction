# 把一份完整的設定 compound 套用到 settings 計分板
# USAGE: function preset:apply with storage duhc:main data.preset.<某份完整設定>
# 註: 難度另由 preset:set_difficulty 處理 (install 不更動難度)
...
$scoreboard players set deathmatch_type settings $(deathmatch_type)
